...
The construction in the paper produces both an in-fill consistent estimate of the RND and a pricing interpolant. In terms of repricing accuracy, it improves upon a naive kernel smoother by a large margin and is competitive with the other established methods. The \citeauthor{yatchew2006} projection remains closer in sample, and PCA is closer on the weighted hold-out.
