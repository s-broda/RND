...
\begin{table}[H]
\centering
\caption{Noisy irregular grids, thirty replications. The first line of each method is the mean and the second is the replication standard deviation. ISE is \(\int_{60}^{140}(\hat f_{\Q}-f_{\Q})^2\,\mathrm{d}K\). RMSE is out-of-the-money pricing error against the clean calls. Yatchew--H\"ardle returns a convex call, not a density curve.}
\label{tab:noise}
\resizebox{\textwidth}{!}{%
...
Pricing cross-validation is run only after the projection, the wing, and the mixture are in place. It chooses \((c,\alpha,s)\) from the grid in the paragraph above, using held-out quotes and not \(f_{\Q}\). The modal Heston choice is \(c=1.25\), \(\alpha=\tfrac12\), \(s=2\) (nine of thirty draws). The mean integrated squared error rises to \(6.6\times 10^{-4}\) under Heston and \(4.2\times 10^{-3}\) under variance gamma. The Heston median is \(4.0\times 10^{-4}\), so the mean is a few draws on which the cross-validation narrows the kernel. Under Heston the cross-validated mixture still beats the convolution and does not beat the local polynomial. Under variance gamma it beats neither. Clean-call error stays near \(0.03\). The projection's second derivative remains a discrete measure. The kernel, Gaussian or mixed, is the step that returns \(\hat f_{\Q}\).
...
\midrule
SPX Dec & Kernel, density scale & 4.88e-1 & 9.46e-1 & 1.01e0 & -1.40e-2 \\
 & Two-step & 4.99e-1 & 8.69e-1 & 1.01e0 & -1.20e-2 \\
 & Mixture, pricing CV & 3.29e-1 & 5.71e-1 & 1.12e0 & -1.10e-1 \\
 & Kernel, pricing CV & 4.15e-1 & 2.86e-1 & 4.28e1 & -4.18e1 \\
 & Yatchew--H\"ardle & 2.20e-2 & 5.40e-2 & {---} & {---} \\
 & A\"{\i}t-Sahalia--Duarte & 4.11e-1 & 5.40e-1 & 1.03e0 & -3.85e-1 \\
 & PCA & 3.96e-2 & 4.28e-2 & 1.00e0 & 0.00e0 \\
 & Priestley--Chao, pricing CV & 9.08e-2 & 3.48e-1 & 1.01e0 & -1.21e-2 \\
 & Priestley--Chao, \(n^{-1/9}\) & 2.05e1 & 2.37e1 & 9.99e-1 & -1.07e-2 \\
 & SVI & 5.32e-1 & 5.32e-1 & 1.00e0 & 0.00e0 \\
\midrule
SPX Mar & Kernel, density scale & 9.55e-1 & 1.90e0 & 1.02e0 & -2.11e-2 \\
 & Two-step & 9.40e-1 & 1.72e0 & 1.01e0 & -2.20e-2 \\
 & Mixture, pricing CV & 5.12e-1 & 1.32e0 & 1.07e0 & -7.40e-2 \\
 & Kernel, pricing CV & 7.36e-1 & 5.24e-1 & 4.02e1 & -3.92e1 \\
 & Yatchew--H\"ardle & 3.80e-2 & 1.41e-1 & {---} & {---} \\
 & A\"{\i}t-Sahalia--Duarte & 6.51e-1 & 8.61e-1 & 1.02e0 & -3.21e-7 \\
 & PCA & 8.73e-2 & 1.02e-1 & 1.00e0 & 0.00e0 \\
 & Priestley--Chao, pricing CV & 3.22e-1 & 1.28e0 & 1.00e0 & -2.14e-3 \\
 & Priestley--Chao, \(n^{-1/9}\) & 2.86e1 & 3.30e1 & 9.97e-1 & -3.51e-1 \\
 & SVI & 1.16e0 & 1.16e0 & 1.00e0 & -1.71e-8 \\
\midrule
NDX Dec & Kernel, density scale & 6.45e0 & 8.74e0 & 1.16e0 & -1.61e-1 \\
 & Two-step & 6.42e0 & 8.82e0 & 1.16e0 & -1.63e-1 \\
 & Mixture, pricing CV & 5.93e0 & 7.83e0 & 1.29e0 & -2.99e-1 \\
 & Kernel, pricing CV & 6.66e0 & 6.86e0 & 1.14e0 & -1.44e-1 \\
 & Yatchew--H\"ardle & 2.06e0 & 3.05e0 & {---} & {---} \\
 & A\"{\i}t-Sahalia--Duarte & 3.72e0 & 4.73e0 & 1.03e0 & -2.10e-2 \\
 & PCA & 2.93e0 & 3.23e0 & 1.00e0 & 0.00e0 \\
 & Priestley--Chao, pricing CV & 2.88e0 & 7.41e0 & 1.02e0 & -2.44e-2 \\
 & Priestley--Chao, \(n^{-1/9}\) & 1.36e2 & 1.57e2 & 9.99e-1 & -3.28e-1 \\
 & SVI & 3.12e0 & 3.29e0 & 1.00e0 & 0.00e0 \\
\midrule
RUT Dec & Kernel, density scale & 4.03e-1 & 9.64e-1 & 1.01e0 & -7.04e-3 \\
 & Two-step & 4.46e-1 & 8.14e-1 & 1.00e0 & -2.00e-3 \\
 & Mixture, pricing CV & 3.58e-1 & 6.27e-1 & 1.10e0 & -1.21e-1 \\
 & Kernel, pricing CV & 5.30e-1 & 7.44e-1 & 1.01e1 & -9.06e0 \\
 & Yatchew--H\"ardle & 2.30e-2 & 1.55e-1 & {---} & {---} \\
 & A\"{\i}t-Sahalia--Duarte & 3.60e-1 & 4.94e-1 & 9.95e-1 & -1.98e-1 \\
 & PCA & 2.92e-2 & 3.29e-2 & 1.00e0 & 0.00e0 \\
 & Priestley--Chao, pricing CV & 2.11e-1 & 8.36e-1 & 9.99e-1 & -9.74e-4 \\
 & Priestley--Chao, \(n^{-1/9}\) & 1.38e1 & 1.59e1 & 9.98e-1 & -2.49e-1 \\
 & SVI & 1.17e-1 & 1.17e-1 & 1.00e0 & 0.00e0 \\
\bottomrule
\end{tabular}%
}
\end{table}

On these four slices the Gaussian two-step tracks the raw density-scale kernel. The quotes are already close to the cone, so the projection moves them by hundredths of an index point and the density-scale bandwidth smooths either curve the same way. December S\&P~500 error is \(0.50\) against \(0.49\). Pricing cross-validation of the mixture, the same grid as in Section~\ref{sec:noise}, lowers that strip to \(0.33\) in sample and \(0.57\) on the hold-out. The positive mass on the window is \(1.12\) and the negative part is \(-0.11\). The unsmoothed projection is still the closest call, at \(0.022\), and the convolution is at \(0.040\). The same ordering holds on the other three slices: cross-validation improves the mixture relative to the fixed wide sinc, and the projection and the convolution remain closer to the quotes.
...
On exact quotes the quadrature corrections bring the integrated squared error to \(5.0\times 10^{-9}\). On noisy quotes the jumps of the raw call are the wrong measure. Projecting the calls and holding the wings at the wing implied volatility, then applying the twiced Gaussian, lowers the Heston mean to \(4.3\times 10^{-4}\). An equal Gaussian--sinc mixture with the sinc at three times the bandwidth, with those constants chosen by integrated squared error on eight pilot replications, lowers the thirty-replication means further, to \(2.8\times 10^{-4}\) and \(1.3\times 10^{-3}\). Pricing cross-validation of the same three constants, after the projection and the wing are already in place, does not recover that pair. The means rise to \(6.6\times 10^{-4}\) and \(4.2\times 10^{-3}\). Under Heston the cross-validated mixture still beats the convolution. Under variance gamma it does not beat the convolution or the local polynomial. On listed slices the quotes already lie near the cone. Cross-validation lowers the December S\&P~500 mixture error from the fixed wide sinc to \(0.33\), and the unsmoothed projection remains at \(0.022\).

The estimator is a fast local approximation of \(f_{\Q}\) on a fine exact strip. Under noise, the lowest integrated squared error in the comparison uses the projected call and a Gaussian--sinc mixture whose constants were chosen for that error. Choosing the constants from prices instead gives back part of the gain. Neither version is the closest interpolant of a listed chain that is already nearly convex.
...
The two-step mixture is \path{python/src/twostep.py}.
